...
public enum ConfigKey {
    ...
    AI_CAR_SPEED,
    AI_CAR_SPAWN_TIME_MIN_SINGLEPLAYER,
    AI_CAR_SPAWN_TIME_MAX_SINGLEPLAYER,
    AI_CAR_SPAWN_TIME_MIN_MULTIPLAYER,
    AI_CAR_SPAWN_TIME_MAX_MULTIPLAYER,
    ...
    OBSTACLE_SPAWN_TIME_MIN_SINGLEPLAYER,
    OBSTACLE_SPAWN_TIME_MAX_SINGLEPLAYER,
    OBSTACLE_SPAWN_TIME_MIN_MULTIPLAYER,
    OBSTACLE_SPAWN_TIME_MAX_MULTIPLAYER,
